...
#ifndef RECEIVE_SERVICE_H  // <- This should be changed to your own guard on both
#define RECEIVE_SERVICE_H  //    of these lines
...
uint8_t InitReceiveService(uint8_t last_bump_received);
