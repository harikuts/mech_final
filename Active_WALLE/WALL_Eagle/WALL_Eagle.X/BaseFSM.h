...
#ifndef FSM_Base_H  // <- This should be changed to your own guard on both
#define FSM_Base_H  //    of these lines
...
uint8_t InitBaseFSM(uint8_t Priority);
 ...
 *        Returns TRUE if successful, FALSE otherwise
 * @author J. Edward Carryer, 2011.10.23 19:25 */
uint8_t PostBaseFSM(ES_Event ThisEvent);
 ...
 * @author J. Edward Carryer, 2011.10.23 19:25 */
ES_Event RunBaseFSM(ES_Event ThisEvent);
